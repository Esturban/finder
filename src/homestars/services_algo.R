...
saveRDS(services_dev,file = here::here("data","homestars","categories","companies_scraped_details_dev_1.RDS"))
...
saveRDS(services_dev,file = here::here("data","homestars","categories","companies_scraped_details_dev_2.RDS"))


services_dev %>%
  # dplyr::select(category, name, url, email, telephone) %>% print(n = 100)
  dplyr::select(category, name, url, email, telephone) %>% readr::write_csv(.,file = "sample_emails_1500.csv")
...
saveRDS(services_dev,file = here::here("data","homestars","categories","companies_scraped_details_dev_all.RDS"))
end<-Sys.time()
end-start